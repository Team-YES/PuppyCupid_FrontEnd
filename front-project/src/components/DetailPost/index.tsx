...
import Comment, { CommentRef } from "../Comments";
...
const DetailPost = ({
  ...
  const handleCommentIconClick = () => {
    commentRef.current?.focusInput(); // 댓글 input 포커스
  };
          ...
          <Detail_RightContainer>
            ...
            <div>
              ...
              <div className="Post_iconContainer">
                ...
                <div className="Post_icon" onClick={handleCommentIconClick}>
