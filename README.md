...
### 💳 결제 페이지
- 유료 기능(프리미엄 매칭 등) 제공을 위한 결제 페이지입니다.
- toss를 사용하여 구현하였습니다.
- 결제 성공, 실패 시 각 페이지로 이동합니다. 

### 🤖 AI 매칭
- AI 기반 알고리즘으로 사용자와 반려동물의 특성을 고려한 친구 추천

### 🐾 산책메이트
- 내 위치 기반으로 산책 친구 찾기
- 산책 일정 등록 및 함께할 사람 모집

### 📝 게시글 등록 / 수정
- 자유롭게 글 작성 및 수정 가능
- 반려동물 후기, 산책기록 등 커뮤니티 활동 지원
...
### 👀 OtherProfile
다른 사용자 및 반려동물 프로필 보기
친구 신청 및 메시지 전송 기능 포함
...
### 🚨 신고하기
부적절한 사용자 또는 게시글 신고
신속한 조치를 위한 신고 사유 입력 기능 제공

### 🛠 admin
관리자 전용 페이지
신고 관리, 사용자 관리, 통계 조회 등 기능 포함
